// Iconos secundarios (marcas de pago, redes sociales, utilidades no usadas hoy).
// Suponen ~17 KB de fuente que ningun render de la SPA referencia actualmente,
// por eso se cargan en un chunk aparte via import() desde Icon.jsx.
